      ...
      for (const item of demoData) {
        try {
          ...
          if (existing) {
            ...
            const updatedExamples = [...(existing.examples || []), ...(examples as Example[])]
            ...
            const newCard: DBVocabularyCard = {
              ...
              kanji: word.kanji,
              kana: word.kana,
              romaji: (word as any).romaji || '',
              meaning: word.meaning,
              jlptLevel: (word as any).jlptLevel || 'N5',
              partOfSpeech: (word as any).partOfSpeech || ['noun'],
              tags: (word as any).tags || [],
              examples: examples as Example[],
              source: (word as any).source || { type: 'custom' },
              license: (word as any).license || {
