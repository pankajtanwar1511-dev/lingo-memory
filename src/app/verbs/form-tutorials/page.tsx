...
const dictRules: FormRule[] = [
  { id: "ichidan", title: "Ichidan Verbs (る-verbs)", pattern: "Vowel + ます → る", rule: "Remove ます, add る",
  ...
  { id: "imasu", title: "Godan: います → う", pattern: "います → う", rule: "Replace います with う",
  ...
  { id: "kimasu", title: "Godan: きます → く", pattern: "きます → く", rule: "Replace きます with く",
  ...
  { id: "gimasu", title: "Godan: ぎます → ぐ", pattern: "ぎます → ぐ", rule: "Replace ぎます with ぐ",
  ...
  { id: "shimasu", title: "Godan: します → す", pattern: "します → す", rule: "Replace します with す",
  ...
  { id: "chimasu", title: "Godan: ちます → つ", pattern: "ちます → つ", rule: "Replace ちます with つ",
  ...
  { id: "nimasu", title: "Godan: にます → ぬ", pattern: "にます → ぬ", rule: "Replace にます with ぬ",
    description: ["Verbs with masu-stem ending in に", "Change に to ぬ", "Rare — main example: 死ぬ (to die)"],
    examples: ["死にます → 死ぬ"],
    examplesKana: ["しにます → しぬ"],
    color: "bg-gradient-to-r from-gray-500 to-slate-500" },
  { id: "bimasu", title: "Godan: びます → ぶ", pattern: "びます → ぶ", rule: "Replace びます with ぶ",
  ...
  { id: "mimasu", title: "Godan: みます → む", pattern: "みます → む", rule: "Replace みます with む",
  ...
  { id: "rimasu", title: "Godan: ります → る", pattern: "ります → る", rule: "Replace ります with る",
...
const dictException: FormRule = {
  id: "exceptions", title: "⚠️ Irregular Verbs — Memorize!", pattern: "Special Cases", rule: "Must be memorized",
...
const teRules: FormRule[] = [
  { id: "ichidan", title: "Ichidan Verbs (る-verbs)", pattern: "Vowel + ます → て", rule: "Remove ます, add て",
    ...
    color: "bg-gradient-to-r from-green-500 to-teal-500" },
  { id: "itte", title: "Godan: い・ち・り + ます → って", pattern: "い/ち/り + ます → って", rule: "Replace い/ち/り with って",
    ...
    color: "bg-gradient-to-r from-blue-500 to-cyan-500" },
  { id: "nde", title: "Godan: み・び・に + ます → んで", pattern: "み/び/に + ます → んで", rule: "Replace み/び/に with んで",
    ...
    color: "bg-gradient-to-r from-purple-500 to-pink-500" },
  { id: "ite", title: "Godan: き + ます → いて", pattern: "き + ます → いて", rule: "Replace き with いて",
    ...
    color: "bg-gradient-to-r from-yellow-500 to-orange-500" },
  { id: "ide", title: "Godan: ぎ + ます → いで", pattern: "ぎ + ます → いで", rule: "Replace ぎ with いで",
    ...
    color: "bg-gradient-to-r from-indigo-500 to-purple-500" },
  { id: "shite", title: "Godan: し + ます → して", pattern: "し + ます → して", rule: "Replace し with して",
...
const teException: FormRule = {
  ...
  description: ["行く is the ONLY き→いて exception (follows って instead)", "Irregular verbs: する, 来る (25 total with compounds)"],
