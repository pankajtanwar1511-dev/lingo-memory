...
export const viewport: Viewport = {
  width: "device-width",
  initialScale: 1,
  // No maximumScale — let mobile users pinch-zoom dense content
  // (kanji stroke diagrams, sentence cards, etc.). Accessibility wins
  // outweigh the small risk of accidental zoom.
  themeColor: [
