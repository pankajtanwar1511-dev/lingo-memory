#!/usr/bin/env python3
"""
Simple Audio Generation using Edge-TTS (Python)
...
Generates audio for all vocabulary words and examples.
"""
...
# Configuration
INPUT_FILE = "public/seed-data/n5-comprehensive.json"
OUTPUT_DIR = "public/audio/n5"
...
async def main():
    print("🎙️  Audio Generation with Microsoft Edge TTS (FREE!)")
    ...
    for card in cards:
        ...
        for idx, example in enumerate(examples, 1):
            ...
            audio_path = f"{OUTPUT_DIR}/examples/{card_id}_ex{idx}.mp3"
            ...
            success = await generate_audio(japanese, audio_path)
            if success:
