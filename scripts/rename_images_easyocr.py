#!/usr/bin/env python3
"""
Read each verb image, extract the text label at bottom using EasyOCR, and rename to correct n5_v_XXXX.png
"""
...
def extract_text_from_image(image_path, reader):
    """Extract text from bottom of image using EasyOCR"""
    ...
    try:
        ...
        img_array = np.array(bottom_crop)
...
def rename_images():
    ...
    for set_num in range(1, 12):
        ...
        for img_file in image_files:
            ...
            extracted_text = extract_text_from_image(img_file, reader)
    ...
    missing_verbs = sorted(all_verb_ids - renamed_verb_ids)
    if missing_verbs:
